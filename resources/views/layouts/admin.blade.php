...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased" onload="load()">
        <div class="h-screen flex overflow-hidden bg-gray-100">
            ...
            <div class="fixed inset-0 flex z-40 md:hidden" role="dialog" aria-modal="true">
              ...
              <!--
                ...
                Leaving: "transition ease-in-out duration-300 transform"
                  ...
                  To: "-translate-x-full"
              -->
              <div id="side-menu" class="transition ease-in-out duration-300 transform relative flex-1 flex flex-col max-w-xs w-full bg-slate-800">
                <!--
            ...
            <div class="hidden bg-slate-800 md:flex md:flex-shrink-0">
