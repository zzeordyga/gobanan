<nav x-data="{ open: false }" class="bg-white border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex">
                ...
                <div class="hidden sm:flex justify-end items-center space-x-4 sm:-my-px">
                    <form action="{{route('search')}}" class="search-bar w-56 hover:w-80">
                        <input type="search" placeholder="Search services here..." class="hidden-search" name="keyword" id="keyword">
                        <button type="submit" class="floating-icon float-right"><i class="fa-solid fa-magnifying-glass"></i></button>
                    </form>
                    <div class="nav-item">
                        <a href="{{route('dashboard')}}" class="font-bold">Home</a>
                    </div>
                    <div class="nav-item">
                        <a href="{{route('explore')}}" class="font-bold">Explore</a>
                    </div>
                    @guest
                        <div class="nav-item">
                ...
                @auth
                    <div class="flex sm:items-center sm:ml-6">
                        ...
                        <!-- Settings Dropdown -->
                        <div class="ml-3 relative font-bold">
                            <x-jet-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    ...
                                    @else
                                        <span class="inline-flex rounded-md">
                                            <button type="button" class="font-bold inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                                {{ Auth::user()->name }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{route('explore')}}">
                {{ __('Explore') }}
            </x-jet-responsive-nav-link>
            @auth
